...
def pos_postprocess(ifobj, owfobj, olfobj, ologfobj):
  ...
  for line in ifobj:
    ...
    for word in words:
      ...
      if matchObj and (matchObj.group(1) == 'GPE' or matchObj.group(1) == 'ORG' or matchObj.group(1) == 'PERSON' or matchObj.group(1) == 'LOC'):
      ...
      matchObj = re.match(r'(.*)</(.*)>', word)
      if matchObj and (matchObj.group(2) == 'GPE' or matchObj.group(2) == 'ORG' or matchObj.group(2) == 'PERSON' or matchObj.group(2) == 'LOC'):
